...
console.log(sum);
// Factorial: Escribe código que multiplique todos los valores del 1 al 12 en una variable product y al final, console.log dé como resultado  1 * 2 * 3 * ... * 10 * 11 * 12. Deberíamos obtener  479001600 al final. //
let product = 1;
for(let i=1; i<13; i++) {
    product *= i;
}
